...
export default function RegisterOrLogin() {
  ...
  if(isMobile){
    return(
      ...
      <div className='flex justify-center items-center h-full gap-x-8 mt-10 flex-col gap-y-12'>
        ...
        <div className='bg-white h-[500px] w-full rounded-xl shadow-xl px-8 py-8 flex flex-col gap-y-6 mb-12'>
  ...
  return (
    <div className='container mx-auto w-full mt-64 mb-20 pt-3' id='starter'>
      <div className='flex justify-center items-center h-full gap-x-8 mt-10'>
        <div className='bg-white h-[500px] w-[60%] rounded-xl shadow-xl px-8 py-8 flex flex-col gap-y-6 relative'>
          ...
          <p className='text-black text-opacity-70 font-montserrat font-medium text-[20px]'>Aşağıdaki butona basarak ücretsiz bir şekilde hesap oluşturabilirsin ve öğrenci avantajlarını inceleyebilirsin.</p>
