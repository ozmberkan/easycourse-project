            ...
            <div className='bg-white w-full h-full rounded-lg shadow-md px-6 py-6 flex flex-col gap-y-2'>
              ...
              <div className='grid grid-cols-2 grid-rows-2 gap-x-4 gap-y-4 items-center py-4'>
                ...
                <div className='relative '>
                  <input type="text" name="teacherCode" id="teacherCode" className='border w-full border-primary-color py-4 text-sm rounded-xl text-center text-primary-color font-montserrat' placeholder='Eğitmen Kodu' />
                  <IoMdArrowDroprightCircle className='absolute right-3 top-[20px] flex items-center cursor-pointer' size={15} />
                </div>
              </div>
