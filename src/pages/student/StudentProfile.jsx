    ...
    return (
      <div className='w-full h-screen bg-[url("/src/assets/mainWallpaper.png")] bg-cover bg-center' >
        <div className='container mx-auto px-4 py-4'>
          <StudentHeader />
          <div className='w-full h-[730px] mt-12 flex gap-x-5 flex-col gap-y-5'>
            <div className='bg-white w-full h-full rounded-lg shadow-md px-6 py-6 flex flex-col gap-y-2'>
              ...
              <div className='grid grid-cols-2 grid-rows-2 gap-x-4 gap-y-4 items-center py-4'>
                <button className='bg-primary-color px-4 py-4 w-full h-[50px] rounded-xl text-center text-white font-montserrat flex justify-center items-center'>Şifre Değiştir</button>
                <button className='bg-primary-color px-4 py-4 w-full h-[50px] rounded-xl text-center text-white font-montserrat flex justify-center items-center'>Bildirim Ayarları</button>
                <button className='bg-primary-color px-4 py-4 w-full h-[50px] rounded-xl text-center text-white font-montserrat flex justify-center items-center'>E-Posta Değiştir</button>
                <input type="text" name="teacherCode" id="teacherCode" className='border w-full border-primary-color py-4 text-sm rounded-xl text-center text-primary-color font-montserrat flex justify-center items-center' placeholder='Eğitmen Kodu' />
              </div>
              <button className='w-full border border-primary-color px-4 py-4 rounded-md font-montserrat'>Eğitmen Kodunu Gönder</button>
              <button className='w-full bg-primary-color text-white px-4 py-4 rounded-md font-montserrat'>Profil Resmi Ekle/Değiştir</button>
            </div>
