      ...
      <div className='bg-white rounded-lg px-4 py-4'>
        ...
        <BottomSheet open={open} onDismiss={() => setOpen(false)}>
          <div className='flex flex-col w-full px-4 py-4 gap-y-4'>
            <Link to="/studentmeet" className='text-primary-color  border border-primary-color  px-4 py-2 rounded-md font-montserrat flex justify-center items-center'>Randevularım</Link>
            <Link to="/studentprofile" className='text-primary-color border border-primary-color  px-4 py-2 rounded-md font-montserrat flex justify-center items-center'>Profilim</Link>
          </div>
        </BottomSheet>
      </div>
    )
