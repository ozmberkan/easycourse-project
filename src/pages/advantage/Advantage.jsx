          ...
          <div className=' w-full flex justify-center items-center flex-col'>
            ...
            <div className='w-full flex justify-center items-center flex-col gap-y-6'>
              <div className='w-full h-full bg-white rounded-2xl py-8 px-8 flex flex-col justify-start items-center relative'>
                ...
                <Link to="/register" className='z-10 border mt-56 bg-white px-4 py-2 rounded-lg flex justify-center items-center w-[250px] border-[#ABABAB] font-montserrat font-extrabold text-primary-color uppercase'>ücretsiz elde et</Link>
                <svg id="visual" viewBox="0 0 900 600" className='absolute bottom-0 left-0 rounded-bl-lg rounded-br-lg  w-full' xmlns="http://www.w3.org/2000/svg" xmlns: xlink="http://www.w3.org/1999/xlink">
              ...
              <div className='w-full h-full bg-white rounded-2xl py-8 px-8 flex flex-col justify-start items-center relative'>
                ...
                <Link to="/register" className='z-10 border mt-56 bg-white px-4 py-2 rounded-lg flex justify-center items-center w-[250px] border-[#ABABAB] font-montserrat font-extrabold text-primary-color uppercase'>satın al</Link>
              ...
              <div className='w-full h-full bg-white rounded-2xl py-8 px-8 flex flex-col justify-start items-center relative'>
                ...
                <Link to="/register" className='z-10 border mt-56 bg-white px-4 py-2 rounded-lg flex justify-center items-center w-[250px] border-[#ABABAB] font-montserrat font-extrabold text-primary-color'>SATIN AL</Link>
