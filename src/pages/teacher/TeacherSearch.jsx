    ...
    return (
      <div className='w-full h-screen bg-[url("/src/assets/mainWallpaper.png")] bg-cover bg-center px-4 py-4' >
        <div className='container mx-auto'>
          <Header />
          <div className='w-full bg-white px-4 py-4 mt-12 rounded-md shadow-md flex justify-center items-center flex-col text-center'>
            <div className='flex flex-col items-center justify-center gap-y-4'>
              <h1 className='text-primary-color font-montserrat text-[30px] font-bold'>Aradığın dersin eğitmenini kolayca bul!</h1>
