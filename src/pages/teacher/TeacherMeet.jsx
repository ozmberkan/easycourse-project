  ...
  if(isMobile){
    return(
      <div className='w-full h-screen bg-[url("/src/assets/mainWallpaper.png")] bg-cover bg-center px-4 py-4' >
        ...
        <div className='bg-white px-6 py-12 container mx-auto mt-6 flex justify-start items-center  rounded-lg flex-col'>
          ...
          <div className='w-full h-full border border-primary-color rounded-xl flex justify-start items-center flex-col '>
